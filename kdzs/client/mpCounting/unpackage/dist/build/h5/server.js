...
function processRequest (request, response) {
	...
	//如果 pathname为根目录 或者 为pc端浏览 或者 pathname没以/结尾，并且没有扩展名
	if (pathName === '/' || pathName === '/pcview/' || (!pathName.endsWith('/') && path.extname(pathName) === '')) {
		console.log(pathName);
		if (pathName.startsWith("/pcview/")) {
			fs.readFile('pcview.html', 'utf-8', (err, content) => {
