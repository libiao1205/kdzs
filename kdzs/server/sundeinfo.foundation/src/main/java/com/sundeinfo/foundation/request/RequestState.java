...
public enum RequestState {
    ...
    PARAM_PERMISSION_EXPORT_EXCEL_UNSUCCESSFUL_SEASON(1307,"导出Excel失败"),
    PARAM_PERMISSION_EXPORT_EXCEL_SUCCESS_SEASON(1308,"导出Excel成功"),
    PARAM_PERMISSION_EXPORT_PDF_UNSUCCESSFUL_SEASON(1307,"导出Pdf失败"),
    PARAM_PERMISSION_EXPORT_PDF_SUCCESS_SEASON(1308,"导出Pdf成功"),
    ...
    PARAM_PASSWORD_NEW_ERROR(10002, "新密码不能接旧密码一致"),
